...
public enum TestBase {
    ...
    public List<Test> get() {
        ...
        try (Statement stmt = conn.createStatement();
                ...
                while(rs.next()) {
                    try {
                        // Get runnable objects from their class names, so that com.kinmanlui.tester can execute these runnable objects
                        Class<?> cs = Class.forName(Resource.ALGORITHM_PATH_WITH_DOTS + rs.getString("ClassName"));
