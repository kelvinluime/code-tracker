/**
 * This com.kinmanlui.tester imports a dictionary file, which is a file full of words separated by a new line.
 * Then it add all the words from this file into the trie. It then asks the com.kinmanlui.user for a string prefix to search in
